    ...
    <div class="col-md-6">
      <div class="card">
        <div class="card-body">
          ...
          <form action="{{ route('users.update',$user->id)}}" id="userForm" name="userForm" method="post">
            <div class="mb-3">
              <label for="firstName" class="form-label">First Name</label>
              <input type="text" class="form-control" id="firstName" name="firstName" value="{{$user->name}}" placeholder="Enter your first name">
              <p></p>
            </div>
            <div class="mb-3">
              <label for="lastName" class="form-label">Last Name</label>
              <input type="text" class="form-control" id="lastName" name="lastName" value="{{$user->last_name}}" placeholder="Enter your last name">
              <p></p>
            </div>
            <div class="mb-3">
